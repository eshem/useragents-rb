Gem::Specification.new do |s|
  ...
  s.files         = ['useragents.gemspec', 'lib/useragents.rb', 'lib/core_ext/blank.rb', 'spec/useragents_spec.rb', 'lib/useragents/fetch.rb', 'lib/useragents.txt', 'README.md', 'LICENSE']
